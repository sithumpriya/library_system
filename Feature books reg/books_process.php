...
if (isset($_POST['update_book']))
{
    ...
    $categories  = mysqli_real_escape_string($conn, $_POST['category_id']);
    ...
    if(mysqli_num_rows($duplicate) > 0) {
        ...
        if($bookID == $bookID_old) {
            $query = "UPDATE book SET book_id='$bookID', book_name='$bookName', category_id='$categories' WHERE book_id='$bookID'";
        } else {
            $query = "UPDATE book SET book_id='$bookID', book_name='$bookName', category_id='$categories' WHERE book_id='$bookID_old'";
        }
